  ...
  export default {
    ...
    methods: {
      ...
      editarMetaGenerica(meta) {
        ...
        let _nivelCap = meta.nivelCap;

        this.editando = true;

        this.novoMetaGenerica.sigla = _sigla;
        this.novoMetaGenerica.nome = _nome;
        this.novoMetaGenerica.descricao = _descricao;
        this.novoMetaGenerica.nivelCap = _nivelCap;

        this.editMetaGenerica.id = _id;
